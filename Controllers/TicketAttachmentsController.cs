...
namespace CSBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,ImageData,ImageType,TicketId,UserId")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Created,ImageData,ImageType,TicketId,UserId")] TicketAttachment ticketAttachment)
        {
