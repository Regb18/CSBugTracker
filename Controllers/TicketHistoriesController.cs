...
namespace CSBugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PropertyName,Description,OldValue,NewValue,TicketId,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PropertyName,Description,OldValue,NewValue,TicketId,UserId")] TicketHistory ticketHistory)
        {
