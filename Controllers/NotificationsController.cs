...
namespace CSBugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,Created,HasBeenViewed,ProjectId,TicketId,NotificationTypeId,SenderId,RecipientId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,Created,HasBeenViewed,ProjectId,TicketId,NotificationTypeId,SenderId,RecipientId")] Notification notification)
        {
